...
jupyter notebook
```
## Note: Data Generation step is not mandatory. You can just download the data from the Google Drive below and just experiment with the notebooks from Custom Model Training section.
...
![Screenshot from 2023-09-09 17-40-19](https://github.com/prabhat-123/Email-Categorization-And-Product-Feedback-Analysis/assets/37154253/01b1d9fc-210b-4a73-b644-d6fab2980062)
